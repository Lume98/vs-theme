...
- `themes/midnight-slate-color-theme.json`：主题颜色与语法高亮规则
...
4. 选择 `Midnight Slate` 主题进行预览。

## 主题文件说明

主题核心文件是 `themes/midnight-slate-color-theme.json`，主要包含两部分：
...
- 修改 `themes/midnight-slate-color-theme.json` 后，开发宿主窗口会自动应用变更
